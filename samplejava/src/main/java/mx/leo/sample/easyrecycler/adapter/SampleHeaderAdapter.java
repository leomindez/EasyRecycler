...
import mx.leo.sample.easyrecycler.viewholder.SampleHeaderViewHolder;
import mx.leo.sample.easyrecycler.viewholder.SampleItemViewHolder;
...
public class SampleHeaderAdapter extends EasyHeaderAdapter<Language> {
    ...
    @Override public void onBindItemViewHolder(@NotNull EasyViewHolder holder, Language language, int position) {
        ((SampleItemViewHolder) holder).bindItem(language);
    }
}
